...
<figure class="supply-chain-diagram">
  <div class="supply-chain-diagram-scroll">
    ...
    >
      ...
      <path class="supply-chain-flow" d="M 942 214 V 281" marker-end="url(#supply-chain-arrow)" />
      ...
      <g class="supply-chain-node supply-chain-node-demand">
        ...
        <text x="117" y="150">用户请求</text>
        <text class="supply-chain-node-small" x="117" y="177">有效 Token</text>
      </g>
      <g class="supply-chain-node supply-chain-node-demand">
        <rect height="110" rx="16" width="164" x="230" y="104" />
        <text x="312" y="150">模型与 Agent</text>
        <text class="supply-chain-node-small" x="312" y="177">规划、工具、推理</text>
      </g>
      <g class="supply-chain-node supply-chain-node-system">
        <rect height="110" rx="16" width="164" x="440" y="104" />
        <text x="522" y="150">GPU / ASIC</text>
        <text class="supply-chain-node-small" x="522" y="177">Prefill 与 Decode</text>
      </g>
      <g class="supply-chain-node supply-chain-node-bottleneck">
        <rect height="110" rx="16" width="164" x="650" y="104" />
        <text x="732" y="150">HBM / DRAM</text>
        <text class="supply-chain-node-small" x="732" y="177">KV Cache 与容量</text>
      </g>
      <g class="supply-chain-node supply-chain-node-bottleneck">
        <rect height="110" rx="16" width="164" x="860" y="104" />
        <text x="942" y="150">先进封装</text>
        <text class="supply-chain-node-small" x="942" y="177">晶圆与 CoWoS</text>
      </g>
      <g class="supply-chain-node supply-chain-node-system">
        <rect height="110" rx="16" width="164" x="860" y="281" />
        <text x="942" y="327">服务器与机架</text>
        <text class="supply-chain-node-small" x="942" y="354">可部署算力</text>
      </g>
      <g class="supply-chain-node supply-chain-node-system">
        <rect height="110" rx="16" width="164" x="650" y="281" />
        <text x="732" y="327">网络互连</text>
        <text class="supply-chain-node-small" x="732" y="354">NVLink、交换、光</text>
      </g>
      <g class="supply-chain-node supply-chain-node-bottleneck">
        <rect height="110" rx="16" width="164" x="440" y="281" />
        <text x="522" y="327">电力与液冷</text>
        <text class="supply-chain-node-small" x="522" y="354">并网、配电、散热</text>
      </g>
      <g class="supply-chain-node supply-chain-node-system">
        <rect height="110" rx="16" width="164" x="230" y="281" />
        <text x="312" y="327">KV Cache / 调度</text>
        <text class="supply-chain-node-small" x="312" y="354">路由、复用、迁移</text>
      </g>
      <g class="supply-chain-node supply-chain-node-demand">
        <rect height="110" rx="16" width="134" x="50" y="281" />
        <text x="117" y="327">可计费服务</text>
        <text class="supply-chain-node-small" x="117" y="354">质量、延迟、成本</text>
      </g>
      ...
      <g class="supply-chain-scene-node">
        ...
        <text x="155" y="546">云推理与 Agent</text>
        <text class="supply-chain-node-small" x="155" y="573">复杂任务与多模型编排</text>
      </g>
      <g class="supply-chain-scene-node">
        <rect height="84" rx="14" width="218" x="334" y="513" />
        <text x="443" y="546">汽车个人助手</text>
        <text class="supply-chain-node-small" x="443" y="573">车控、导航、端云协同</text>
      </g>
      <g class="supply-chain-scene-node">
        <rect height="84" rx="14" width="244" x="626" y="513" />
        <text x="748" y="546">家庭控制中枢</text>
        <text class="supply-chain-node-small" x="748" y="573">传感器、工具、权限与记忆</text>
      </g>

      <text class="supply-chain-heading supply-chain-risk-heading" x="50" y="683">
        金融放大链
      </text>
      <text class="supply-chain-subheading" x="50" y="710">
        虚线是条件性风险，只有 Token 需求、利用率或续约低于采购假设时才会展开
      </text>
      <path class="supply-chain-risk-flow" d="M 370 777 H 442" marker-end="url(#supply-chain-risk-arrow)" />
      <path class="supply-chain-risk-flow" d="M 656 777 H 728" marker-end="url(#supply-chain-risk-arrow)" />
      <path class="supply-chain-risk-flow" d="M 948 777 H 1000" marker-end="url(#supply-chain-risk-arrow)" />
      <g class="supply-chain-risk-node">
        <rect height="76" rx="14" width="320" x="50" y="739" />
        <text x="210" y="768">长期合同、预付款、租赁与 SPV</text>
        <text class="supply-chain-node-small" x="210" y="795">采购约束下降</text>
      </g>
      <g class="supply-chain-risk-node">
        <rect height="76" rx="14" width="214" x="442" y="739" />
        <text x="549" y="768">提前采购与扩产</text>
        <text class="supply-chain-node-small" x="549" y="795">GPU、内存、机房</text>
      </g>
      <g class="supply-chain-risk-node">
        <rect height="76" rx="14" width="220" x="728" y="739" />
        <text x="838" y="768">低利用率或订单放缓</text>
        <text class="supply-chain-node-small" x="838" y="795">情景触发条件</text>
      </g>
      <g class="supply-chain-risk-node">
        <rect height="76" rx="14" width="70" x="1000" y="739" />
        <text class="supply-chain-node-small" x="1035" y="768">库存</text>
        <text class="supply-chain-node-small" x="1035" y="795">残值</text>
      </g>
    </svg>
  </div>
  <figcaption>
